...
-- Adapted from https://github.com/clvnkhr/macaltkey.nvim/blob/master/lua/macaltkey/dicts.lua
local mac_alt_option_mapping = {
    a = "å",
    b = "∫",
    c = "ç",
    d = "∂",
...
-- Maps alt to option key on mac
---@param key string the key after alt in a keymap
---@return string keymap the eventual keymap
utils.alt = function(key)
    if utils.is_mac() then
        return mac_alt_option_mapping[key]
    else
        return "<A-" .. key .. ">"
    end
end
